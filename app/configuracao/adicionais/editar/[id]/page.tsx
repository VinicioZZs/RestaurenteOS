...
export default function EditarAdicionalPage() {
 ...
 const [formData, setFormData] = useState<AdicionalData>({
  ...
  setFormData({
    ...
    gratuito: adicional.gratuito !== undefined ? adicional.gratuito : false, // ← NOVO
...
// PERMITE PREÇO 0 SE FOR GRATUITO
if (!formData.gratuito && (!formData.preco || formData.preco <= 0)) {
  ...
  {formData.gratuito ? (
    <div className="mt-2 p-3 bg-green-50 border border-green-200 rounded">
      <p className="text-sm text-green-700">
        ✅ Este adicional é oferecido sem custo adicional ao cliente.
      </p>
    ...
    <p className="text-sm text-gray-500 mt-1">
      Marque esta opção para oferecer este adicional gratuitamente
    </p>
  )}
</div>
          ...
          <div className="flex justify-between space-x-4">
            ...
            <div className="flex space-x-4">
              ...
              <button
                type="submit"
                disabled={enviando || !formData.nome || (!formData.gratuito && !formData.preco)}
